...
class TractOracleAutoencoderTraining():
    """
    ...
    def train(
        ...
        if self.checkpoint:
            model = AutoencoderOracle.load_from_checkpoint(self.checkpoint)
        else:
            model = AutoencoderOracle(
        ...
        comet_logger.log_hyperparams({
            "model": AutoencoderOracle.__name__,
            "lr": self.lr,
            "max_ep": self.max_ep,
            "layers": self.layers,
...
def main():
    ...
    experiment = TractOracleAutoencoderTraining(vars(args))
    experiment.run()
